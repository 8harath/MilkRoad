  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="border-4 border-black p-8 md:p-12 bg-white brutal-shadow-lg mb-8">
        ...
        <div className="border-4 border-black p-8 md:p-12 bg-white brutal-shadow-lg mb-8">
          ...
          <div className="space-y-6 text-lg text-gray-900">
            <div>
              <h3 className="text-xl font-bold text-black mb-3">📅 Cut-off Date</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold text-black mb-3">🤝 Help Us Grow</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold text-black mb-3">⚖️ Legal Notice</h3>
              <p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-xl font-bold text-black underline hover:text-gray-700"
                >
